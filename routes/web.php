...
Route::group(['prefix'=>'admin/email-marketing', 'middleware'=> 'admin'],function(){
    ...
    Route::get('emailgroup/contact/remove','Admin\emailCampaign\GroupController@removeContact');
    // Route::get('emailgroup/mass-delete','Admin\emailCampaign\GroupController@massRemove');
    Route::post('emailgroup/mass-remove','Admin\emailCampaign\GroupController@massRemove');
    Route::post('emailgroup/mass-delete', 'Admin\emailCampaign\GroupController@MassDelete');
