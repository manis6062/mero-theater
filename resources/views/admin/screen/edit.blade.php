                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="artist-form">
                                        <form action="{{url('admin/seat-management/screens/'.$screen->slug.'/update')}}"
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9">
                                                    <input type="text" name="screen_number"
                                                           value="{{$screen->screen_number}}" class="form-control"
                                                           id="screen-number"
                                            ...
                                            <div class="form-group row">
                                                <label class="col-lg-3 col-form-label form-control-label">House
                                                    Seats</label>
                                                <div class="col-lg-9">
                                                    <input type="text" name="house_seats"
                                                           value="{{$screen->house_seats}}" class="form-control"
                                                           id="house-seats"
                                                           onfocus="removeError();"
                                                           placeholder="Enter House Seats Value (Optional)">
                                            ...
                                            <div class="form-group row">
                                                <label class="col-lg-3 col-form-label form-control-label">Wheel Chair
                                                    Seats</label>
                                                <div class="col-lg-9">
                                                    <input type="text" name="wheel_chair_seats"
                                                           value="{{$screen->wheel_chair_seats}}" class="form-control"
                                                           id="wheel-chair-seats"
                                                           onfocus="removeError();"
                                                           placeholder="Enter Wheel Chair Seats Value (Optional)">
                                            ...
                                            <div class="form-group row">
                                                <label class="col-lg-3 col-form-label form-control-label">Available Seat
                                                    Image <span class="note">(Dimension 25x25 | Max Size 2mb | Format jpeg, jpg, png, bmp, svg)</span></label>
                                                <div class="col-lg-9">
                                                    <div class="existingImage">
                                                        <span>Currently Existing Image</span>
                                                        <img src="{{asset('screen/available-seat-image/'.$screen->available_seat)}}"
                                                             alt="">
                                                    </div>
                                                    <input type="file" id="available_seat" name="available_seat"
                                                           onclick="removeError();">
                                            ...
                                            <div class="form-group row">
                                                <label class="col-lg-3 col-form-label form-control-label">Selected Seat
                                                    Image <span class="note">(Dimension 25x25 | Max Size 2mb | Format jpeg, jpg, png, bmp, svg)</span></label>
                                                <div class="col-lg-9">
                                                    <div class="existingImage">
                                                        <span>Currently Existing Image</span>
                                                        <img src="{{asset('screen/selected-seat-image/'.$screen->selected_seat)}}"
                                                             alt="">
                                                    </div>
                                                    <input type="file" id="selected_seat" name="selected_seat"
                                                           onclick="removeError();">
                                            ...
                                            <div class="form-group row">
                                                <label class="col-lg-3 col-form-label form-control-label">Reserved Seat
                                                    Image <span class="note">(Dimension 25x25 | Max Size 2mb | Format jpeg, jpg, png, bmp, svg)</span></label>
                                                <div class="col-lg-9">
                                                    <div class="existingImage">
                                                        <span>Currently Existing Image</span>
                                                        <img src="{{asset('screen/reserved-seat-image/'.$screen->reserved_seat)}}"
                                                             alt="">
                                                    </div>
                                                    <input type="file" id="reserved_seat" name="reserved_seat"
                                                           onclick="removeError();">
                                            ...
                                            <div class="form-group row">
                                                <label class="col-lg-3 col-form-label form-control-label">Sold Seat
                                                    Image <span class="note">(Dimension 25x25 | Max Size 2mb | Format jpeg, jpg, png, bmp, svg)</span></label>
                                                <div class="col-lg-9">
                                                    <div class="existingImage">
                                                        <span>Currently Existing Image</span>
                                                        <img src="{{asset('screen/sold-seat-image/'.$screen->sold_seat)}}"
                                                             alt="">
                                                    </div>
                                                    <input type="file" id="sold_seat" name="sold_seat"
                                                           onclick="removeError();">
