            ...
            <div class="site-setting-general">
                ...
                <div class="mws-panel grid_8">
                    <div class="mws-panel-header">
                        <span><i class="icol32-add"></i> Edit Contact Us</span>
                    </div>
                    <div class="mws-panel-body no-padding">
                        <form style="padding: 1% 3%;" action="{{url('admin/content-management/contact-us/update/'.$editdata->id)}}" class="form-horizontal" method="post" id="createForm" enctype="multipart/form-data">
                            {{csrf_field()}}
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" id="email" name="email" class="form-control" value="{{$editdata->email}}">
                                </div>
                                @if($errors->has('email'))
                                    <span class="help-block">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" id="phone_no" name="phone_no" class="form-control" value="{{$editdata->phone_no}}" >
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="message" id="message" cols="120" rows="10">{{$editdata->phone_no}}</textarea>
                                </div>
