                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="artist-form">
                                    <form class="form" role="form" autocomplete="off" id="createForm" action="{{url('admin/content-management/payment-gateway/update/'.$editdata->id)}}" method="post" enctype="multipart/form-data">
                                         {{csrf_field()}}
