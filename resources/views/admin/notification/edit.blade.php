...
<!-- BEGIN .main-content -->
            ...
            <form class="form" role="form" autocomplete="off" action="{{url('admin/content-management/notification/footer/update/'.$editdata->id)}}"  method="post" id="createForm" enctype="multipart/form-data">
                                                        {{csrf_field()}}
                                                        <div class="form-group row">
                                            <label class="col-lg-3 col-form-label form-control-label">Name <span class="req">*</span></label>
                                            <div class="col-lg-9">
                                                <input class="form-control" type="text" id="name" value="{{$editdata->name}}" name="name" onfocus="removeError();" placeholder="Enter Name">
                                                 @if($errors->has('name'))
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9">
                                                <input class="form-control" id="text" type="text" name="text" value="{{$editdata->text}}" onfocus="removeError();" placeholder="Enter Text">
                                                 @if($errors->has('text'))
                                                    <span class="help-block">
                                                        <strong>
                                                            {{$errors->first('text')}}
