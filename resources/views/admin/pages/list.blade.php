...
@section('main-body')
 ...
 <a href="{{url('admin/content-management/manage-pages/'.$dat->id.'/edit')}}" class="table-content-edit" data-toggle="tooltip"
                                                       data-placement="top" title="Edit">
                                                        <i class="icon-edit2"></i>Edit
                                                    </a>

                                                       <a href="#" class="table-content-delete delete-page" data-id="{{$dat->id}}" data-toggle="tooltip"
