...
<!-- BEGIN .main-content -->
            ...
            <form class="form" role="form" autocomplete="off" action="{{url('admin/content-management/social-media/submit')}}"  method="post" id="createForm" enctype="multipart/form-data">
                                                        {{csrf_field()}}
                                                ...
                                                <span class="link-error error help-block"></span>
                                                               ...
                                                               <div class="form-group row">
                                                            <label class="col-lg-3 col-form-label form-control-label">Icon<br><span class="note">(Dimension 32x32 | Max Size 2mb | Format jpeg, jpg, png, bmp, svg)</span></label>
                                                            <div class="col-lg-9">
           ...
           $('.error').html('');
            if ($('#name').val() == '') {
                ...
                $('.link-error').html('<strong>Please enter the link.</strong>');
                 ...
                 if ($('#icon').val() == '') {
                e.preventDefault();
                $('.icons-error').html('<strong>Please upload the icon.</strong>');
            }
