...
<!-- BEGIN .main-content -->
            ...
            <form class="form" role="form" autocomplete="off" action="{{url('admin/content-management/promotional-banner/submit')}}"  method="post" id="createForm" enctype="multipart/form-data">
                                                        {{csrf_field()}}
                                                        <div class="form-group row">
                                                            <label class="col-lg-3 col-form-label form-control-label">Name <span class="req">*</span></label>
                                                            <div class="col-lg-9">
                                                                 <input class="form-control" type="text"  name="banner_name" id="banner_name" value="{{old('banner_name')}}" name="banner_name" onfocus="removeError();" placeholder="Enter Name">
                                                ...
                                                @endif
                                                <span class="banner_name-error error help-block"></span>
                                                            </div>
                                                        </div>
