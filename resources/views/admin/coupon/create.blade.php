...
<!-- BEGIN .main-content -->
            ...
            <form class="form" role="form" autocomplete="off" action="{{url('admin/coupon/submit')}}"  method="post" id="createForm" enctype="multipart/form-data">
                                                        {{csrf_field()}}
                                                        <div class="form-group row">
                                                            <label class="col-lg-3 col-form-label form-control-label">Coupon code <span class="req">*</span></label>
                                                            <div class="col-lg-6">
                                                                 <input class="form-control" type="text"  name="code" id="code" value="{{old('code')}}" name="code" onfocus="removeError();" placeholder="Enter Coupon Code">
                                                                  @if($errors->has('code'))
                                                ...
                                                <span class="code-error error help-block"></span>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-6">
                                                                 <input class="form-control" type="text"  name="discount_rate" id="code" value="{{old('discount_rate')}}" name="discount_rate" onfocus="removeError();" placeholder="Enter Discount Rate">
                                                ...
                                                <span class="code-error error help-block"></span>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-6">
                                                            <input class="form-control" type="text"  name="count" id="count" value="{{old('count')}}" name="count" onfocus="removeError();" placeholder="Enter Available Numbers">
                                                                  @if($errors->has('count'))
                                                    <span class="help-block">
                                                        <strong>
                                                            {{$errors->first('count')}}
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-6">
                                                                <div class="input-group date">
                                                                  <input type="text" id="expire" name="expire" class="form-control" value="{{old('expire')}}" onfocus="removeError();" placeholder="Choose Expire Date"> <span class="input-group-addon"><i class="icon-calendar"></i></span>
