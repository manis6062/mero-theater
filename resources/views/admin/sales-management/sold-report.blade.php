        ...
        <div class="main-content">
            ...
            <div class="row gutters transaction-profile" id="tabular-data-section">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                    <div class="card">
                        <div class="card-header">Transaction log user wise <a href="#"
                                                                              class="btn btn-primary">Export</a></div>
            ...
            {{--@if(isset($soldReports) && $soldReports->count() > 0)--}}
            {{--{!! $soldReports->appends(\Illuminate\Support\Facades\Input::except('page'))->links() !!}--}}
            {{--@endif--}}
            {{--<ul class="pagination">--}}
            ...
            {{--<a href="#" aria-controls="basicExample" data-dt-idx="3" tabindex="0" class="page-link">Next</a>--}}
            {{--</li>--}}
            {{--</ul>--}}
        </div>
        <!-- END: .main-content -->
...
//        $('#reporitng-table').dataTable();
    ...
    <script>
        ...
        $(window).on('load', function () {
            @if(isset($_GET['page']))
$('html, body').animate({
                scrollTop: $("#tabular-data-section").offset().top - 80
            }, 500);
            @endif
        });
    </script>
