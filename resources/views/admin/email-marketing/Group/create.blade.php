                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="artist-form">
                                    <form action="{{Route('emailgroup.store')}}" class="form-horizontal" id="create-form" method="post">
                                    {{csrf_field()}}
                                    <div class="form-group row">
                                        <label class="col-lg-3 col-form-label form-control-label">Group Name<span class="req">*</span></label>
                                        <div class="col-lg-9">
                                            <input type="text" name="name" value="{{old('name')}}" class="form-control" id="group-name"
