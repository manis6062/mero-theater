            ...
            <ul class="unifyMenu" id="unifyMenu">
                ...
                <li>
                    ...
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <li>
                            <a href="{{url('admin/box-office/smsCampaigns/message/history')}}">
										<span class="has-icon">
											<i class="icon-announcement"></i>
										</span>
                                <span class="nav-title">Campaign History </span>
                            </a>
                        </li>
                        <li>
                            <a href="{{url('admin/box-office/smsCampaigns/template')}}">
										<span class="has-icon">
											<i class="icon-list-numbered"></i>
										</span>
                                <span class="nav-title">List Template </span>
                ...
                <li>
                    ...
                    <ul aria-expanded="false">
                        <li>
                            <a href="{{url('admin/sales-management/reservation-reports')}}">
										<span class="has-icon">
                        ...
                        <li>
                            <a href="{{url('admin/sales-management/transaction-log')}}">
										<span class="has-icon">
