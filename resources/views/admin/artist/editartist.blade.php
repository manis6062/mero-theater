                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="artist-form">
                                                    <form class="form" role="form" autocomplete="off" action="{{url('admin/box-office/artist/update/'.$editdata->id)}}"  method="post" id="createArtistForm" enctype="multipart/form-data">
                                                        {{csrf_field()}}
                                                        <div class="form-group row">
                                                            <label class="col-lg-3 col-form-label form-control-label">Name <span class="req">*</span></label>
                                                            <div class="col-lg-9">
                                                                 <input type="text" id="artistName" name="artist_name" class="form-control" value="{{$editdata->artists_name}}" onfocus="removeError();" placeholder="Enter Artist Name">
                                ...
                                <img src="{{asset('artists/'.$editdata->artists_avatar)}}" alt="">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-9">
                                                                <label class="custom-file">
                                                                  <input  onfocus="removeError();" type="file" id="artistAvatar file2" name="artist_avatar" class="custom-file-input">
                                                ...
                                                @endif
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-9">
 <textarea name="artist_current_status" id="artistCurrentStatus" rows="5" class="form-control" placeholder="Type your cureent status" onfocus="removeError();">{{$editdata->artists_current_status}}</textarea>
   @if($errors->has('artist_current_status'))
                                                ...
                                                <span class="artist-current-status-error error help-block"></span>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-9">
                                                                 <textarea name="artist_early_life" id="artistEarlyLife" placeholder="Type early life" rows="5" class="form-control" onfocus="removeError();" >{{$editdata->artists_early_life}}</textarea>
...
<textarea name="artist_achievements" id="artistAchievements" rows="5" class="form-control" placeholder="Type artist achievments" onfocus="removeError();" value="{{old('artist_achievements')}}">{{$editdata->artists_achievements}}</textarea>
 @if($errors->has('artist_achievements'))
                                                ...
                                                <span class="artist-achievements-error error help-block"></span>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-9">
                                                                 <input type="text" id="artistHashTags" name="artist_hash_tags" class="form-control" value="{{$editdata->hashtag}}" onfocus="removeError();" placeholder="Type artist hashtags">
                        ...
                        if (fileOrg) {
                            ...
                            img.onload = function () {
                                ...
                                if (widthOfImg != 25 && heightOfImg != 25) {
                                    ...
                                    $('.subModalBtn').prop('disabled', true);
                                    $(".avatar-filename").text('');
                                    $('.subModalBtn').css('background-color', '#DA1113');
