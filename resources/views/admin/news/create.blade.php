            ...
            <div class="site-setting-general">
                ...
                <div class="mws-panel grid_8">
                    <div class="mws-panel-header">
                        <span><i class="icol32-add"></i> Add News</span>
                    </div>
                    <div class="mws-panel-body no-padding">
                        <form style="padding: 1% 3%;" action="{{url('admin/content-management/manage-news/news/submit')}}" class="form-horizontal" method="post" id="createForm" enctype="multipart/form-data">
                            {{csrf_field()}}
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control" rows="10" name="meta_description" >{{old('meta_description')}}</textarea>
                                </div>
                            ...
                            <div class="form-group row">
                                <label for="metadescription" class="col-sm-2 control-label" >Featured Image:<span class="req">*</span> </label>
                                <div class="col-sm-10">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="caption" value="{{old('caption')}}" class="form-control" id="caption">
                                </div>
...
@section('scripts')
    <script>
        $('#createForm').on('submit', function (e) {
            if ( $('#title').val() == '' || $('#category').val() == '' || $('#description').val() == '' || $('#meta_title').val() == '' || $('#meta_description').val() == '' || $('#featured_image').val() == '' || $('#caption').val() == '') 
            {
                e.preventDefault();
