...
<!-- BEGIN .main-content -->
            ...
            <form class="form" role="form" autocomplete="off" action="{{url('admin/content-management/manage-news/news/submit')}}"  method="post" id="createForm" enctype="multipart/form-data">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-9">
                                                                <input type="text" id="title" name="title" class="form-control" value="{{old('title')}}" onfocus="removeError();" placeholder="Enter Title">
                                                                  @if($errors->has('title'))
   ...
   @if($errors->has('category'))
                                ...
                                @endif
                                                <span class="category-error error help-block"></span>
                                                            ...
                                                            <div class="col-lg-9">
 <textarea name="description" value="{{old('description')}}" id="description" rows="5" class="form-control" placeholder="Type News Contents" onfocus="removeError();" ></textarea>
   @if($errors->has('body'))
                                    <span class="help-block">
                                ...
                                @endif
                                                <span class="description-error error help-block"></span>
                                                            ...
                                                            <div class="col-lg-9">
                                                                <input type="text" id="meta_title" name="meta_title" class="form-control" value="{{old('meta_title')}}" onfocus="removeError();" placeholder="Enter Meta Title">
                                                ...
                                                <span class="meta_title-error error help-block"></span>
                                                           ...
                                                           <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-9">
 <textarea name="meta_description" id="meta_description" rows="5" class="form-control" placeholder="Type Meta Description" onfocus="removeError();" ></textarea>
   @if($errors->has('body'))
                                    <span class="help-block">
                                ...
                                @endif
                                                ...
                                                @endif
                                                            ...
                                                            <div class="col-lg-9">
                                                                <input type="text" id="caption" name="caption" class="form-control" value="{{old('caption')}}" onfocus="removeError();" placeholder="Enter Caption">
           ...
           $('.error').html('');
            if ($('#title').val() == '') {
             ...
             if ($('#category').val() == '') {
                ...
                e.preventDefault();
                $('.featured_image-error').html('<strong>Please upload the featured image.</strong>');
            }
